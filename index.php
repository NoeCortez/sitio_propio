  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/Mejores-películas.jpg" class="d-block w-100" alt="cartelera1">
      ...
      <div class="carousel-item">
        <img src="img/peliculas-google-2018.jpg" class="d-block w-100" alt="cartelera2">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="img/maxresdefault.jpg" class="d-block w-100" alt="cartelera3">
        <div class="carousel-caption d-none d-md-block">
